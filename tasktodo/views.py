...
from tasktodo.forms import TaskForm, PositionSearchForm, TaskTypeSearchForm, WorkerSearchForm, TaskSearchForm, \
    WorkerCreationForm
...
def toggle_assign_to_task(request, pk):
    ...
    if (
        ...
        worker.tasks.add(pk)
    return HttpResponseRedirect(reverse_lazy("tasktodo:task-detail", args=[pk]))
